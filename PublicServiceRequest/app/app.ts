module app {
    ...
    appMain.config(function ($stateProvider: ng.ui.IStateProvider, $urlRouterProvider: ng.ui.IUrlRouterProvider, $locationProvider: ng.ILocationProvider, appSettings: any, $compileProvider: ng.ICompileProvider) {
        ...
        $stateProvider
            ...
            .state('ServiceRequest', {
                ...
                resolve: {
                    ...
                    serviceTypeOwnerGroupListResolved: (dataAccessService: app.common.DataAccessService) => {
                        ...
                        return serviceTypeOwnerGroupResource.get().$promise.catch((reason: any) => {
                            console.log(reason);
                        });
                    }
                }
            ...
            .state('ServiceRequest.RequestForm', {
                ...
                views: {
                    '': {
                        ...
                        resolve: {
                            dataAccessService: 'dataAccessService',
                            serviceTypeResolved: ($stateParams: IUIRouterCustomStateParams, dataAccessService: app.common.DataAccessService) => {
                                var serviceTypeResource = dataAccessService.getServiceTypeResource('');
                                return serviceTypeResource.getServiceTypeByID({ id: $stateParams.Id }).$promise.catch((reason: any) => {
                                    console.log(reason);
                                });
                            },
                            requestPrioritiesResolved: (dataAccessService: app.common.DataAccessService) => {
                                var requestPriorityResource = dataAccessService.getRequestPriorityResource('');
                                return requestPriorityResource.get().$promise.catch((reason) => {
                                    console.log(reason);
                                });
                            },
                            requestTaxpayerPreferredLanguagesResolved: (dataAccessService: app.common.DataAccessService) => {
                                var requestTaxpayerPreferredLanguagesResource = dataAccessService.getRequestTaxpayerPreferredLanguageResource('');
                                return requestTaxpayerPreferredLanguagesResource.get().$promise.catch((reason) => {
                                    console.log(reason);
                                });
                            },
                            requestResolved: ($stateParams: IUIRouterCustomStateParams, dataAccessService: app.common.DataAccessService) => {
                                var requestResource = dataAccessService.getRequestResource('/InitializeRequest');
                                var serviceTypeID = $stateParams.Id;
                                return new requestResource({ ServiceTypeID: serviceTypeID }).$save().catch((reason) => {
                                    console.log(reason);
                                });
                            }
                        }
    ...
    interface IUIRouterCustomStateParams extends ng.ui.IStateParamsService {
        Id: number;
    }
}